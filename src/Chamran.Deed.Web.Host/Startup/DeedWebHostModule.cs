...
{
    [DependsOn(
        typeof(DeedWebCoreModule)
    )]
    public class DeedWebHostModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public DeedWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(DeedWebHostModule).GetAssembly());
        }
