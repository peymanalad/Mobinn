...
using Chamran.Deed.Core.Base;
using Chamran.Deed.Core.Extensions;
using Chamran.Deed.Dto;
using Chamran.Deed.Types;

namespace Chamran.Deed.Queries
{
    public class OrganizationUnitQuery : DeedQueryBase<ListGraphType<OrganizationUnitType>, List<OrganizationUnitDto>>
    {
