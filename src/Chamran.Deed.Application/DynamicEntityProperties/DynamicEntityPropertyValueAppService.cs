...
using Chamran.Deed.DynamicEntityPropertyValues.Dto;
...
namespace Chamran.Deed.DynamicEntityProperties
{
    ...
    public class DynamicEntityPropertyValueAppService : DeedAppServiceBase, IDynamicEntityPropertyValueAppService
    {
