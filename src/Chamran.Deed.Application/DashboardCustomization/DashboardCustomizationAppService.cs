...
using Chamran.Deed.DashboardCustomization.Dto;
using Newtonsoft.Json;

namespace Chamran.Deed.DashboardCustomization
{
    [AbpAuthorize]
    public class DashboardCustomizationAppService : DeedAppServiceBase, IDashboardCustomizationAppService
    {
