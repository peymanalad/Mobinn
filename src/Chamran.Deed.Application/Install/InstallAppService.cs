...
namespace Chamran.Deed.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : DeedAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<DeedDbContext> _migrator;
        ...
        {
            var connectionString = _appConfiguration[$"ConnectionStrings:{DeedConsts.ConnectionStringName}"];
        ...
        {
            EditAppSettingsjson($"ConnectionStrings:{DeedConsts.ConnectionStringName}", constring);
        }
