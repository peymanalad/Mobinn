...
{
    public class SessionAppService : DeedAppServiceBase, ISessionAppService
    {
            ...
            return await _unitOfWorkManager.WithUnitOfWorkAsync(async () =>
            {
                var output = new GetCurrentLoginInformationsOutput
                {
                    Application = new ApplicationInfoDto
                    {
                        ...
                        CurrencySign = DeedConsts.CurrencySign,
                        AllowTenantsToChangeEmailSettings = DeedConsts.AllowTenantsToChangeEmailSettings,
