...
using Chamran.Deed.Auditing.Exporting;
using Chamran.Deed.Authorization;
using Chamran.Deed.Authorization.Users;
using Chamran.Deed.Dto;
using Chamran.Deed.EntityHistory;
using EntityHistoryHelper = Chamran.Deed.EntityHistory.EntityHistoryHelper;

namespace Chamran.Deed.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : DeedAppServiceBase, IAuditLogAppService
    {
