...
using Chamran.Deed.Controls;
using Chamran.Deed.Dto;
using Chamran.Deed.Extensions;
using Chamran.Deed.Localization;
using Chamran.Deed.UI;
using Chamran.Deed.UI.Assets;
using Chamran.Deed.Views;
using DependencyResolver = Chamran.Deed.Core.Dependency.DependencyResolver;

namespace Chamran.Deed.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "Deed";
