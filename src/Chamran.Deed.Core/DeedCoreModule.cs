...
using Chamran.Deed.Authorization.Ldap;
using Chamran.Deed.Authorization.Roles;
using Chamran.Deed.Authorization.Users;
using Chamran.Deed.Chat;
using Chamran.Deed.Configuration;
using Chamran.Deed.DashboardCustomization.Definitions;
using Chamran.Deed.Debugging;
using Chamran.Deed.DynamicEntityProperties;
...
{
    [DependsOn(
        typeof(DeedCoreSharedModule),
        typeof(AbpZeroCoreModule),
        typeof(AbpZeroLdapModule),
        typeof(AbpAutoMapperModule),
        typeof(AbpAspNetZeroCoreModule),
        typeof(AbpMailKitModule))]
    public class DeedCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            DeedLocalizationConfigurer.Configure(Configuration.Localization);
            ...
            Configuration.MultiTenancy.IsEnabled = DeedConsts.MultiTenancyEnabled;
            ...
            //Store binary objects on the file system instead of the database
            Configuration.ReplaceService<IBinaryObjectManager, DbBinaryObjectManager>(
            ...
            Configuration.ReplaceService<IMailKitSmtpBuilder, DeedMailKitSmtpBuilder>(DependencyLifeStyle.Transient);
            ...
            Configuration.ReplaceService(typeof(IEmailSenderConfiguration), () =>
            {
                Configuration.IocManager.IocContainer.Register(
                    Component.For<IEmailSenderConfiguration, ISmtpEmailSenderConfiguration>()
                             .ImplementedBy<DeedSmtpEmailSenderConfiguration>()
                             .LifestyleTransient()
                );
            });
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(DeedCoreModule).GetAssembly());
        }
