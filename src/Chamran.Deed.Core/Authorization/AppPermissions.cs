namespace Chamran.Deed.Authorization
{
    ...
    public static class AppPermissions
    {
        ...
        public const string Pages_TaskStats_Delete = "Pages.TaskStats.Delete";

        public const string Pages_TaskEntries = "Pages.TaskEntries";
        public const string Pages_TaskEntries_Create = "Pages.TaskEntries.Create";
        public const string Pages_TaskEntries_Edit = "Pages.TaskEntries.Edit";
        public const string Pages_TaskEntries_Delete = "Pages.TaskEntries.Delete";
        ...
        public const string Pages_UserPostGroups_Delete = "Pages.UserPostGroups.Delete";

        public const string Pages_UserLocations = "Pages.UserLocations";
        public const string Pages_UserLocations_Create = "Pages.UserLocations.Create";
        public const string Pages_UserLocations_Edit = "Pages.UserLocations.Edit";
        public const string Pages_UserLocations_Delete = "Pages.UserLocations.Delete";
