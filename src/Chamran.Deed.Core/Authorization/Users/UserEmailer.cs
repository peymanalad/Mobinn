...
namespace Chamran.Deed.Authorization.Users
{
    ...
    /// </summary>
    public class UserEmailer : DeedServiceBase, IUserEmailer, ITransientDependency
    {
        ...
        public async Task SendPasswordResetLinkAsync(User user, string link = null)
        {
            ...
            if (!link.IsNullOrEmpty())
            {
                ...
                var expireDate = Uri.EscapeDataString(Clock.Now.AddHours(expirationHours).ToString(DeedConsts.DateTimeOffsetFormat));
