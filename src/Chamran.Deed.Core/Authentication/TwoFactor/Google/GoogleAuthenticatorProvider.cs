...
namespace Chamran.Deed.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : DeedServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("Chamran.Deed", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
