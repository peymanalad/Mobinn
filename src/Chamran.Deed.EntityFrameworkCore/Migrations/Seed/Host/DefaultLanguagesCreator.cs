...
namespace Chamran.Deed.Migrations.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = DeedConsts.MultiTenancyEnabled ? null : (int?)1;
            return new List<ApplicationLanguage>
            {
                new ApplicationLanguage(tenantId, "fa-AF", "فارسی", "famfamfam-flags ir"),
        ...
        public DefaultLanguagesCreator(DeedDbContext context)
        {
            _context = context;
        }
