...
namespace Chamran.Deed.Migrations
{
    ...
    partial class Added_GoogleAuthenticatorKey_Column
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("Chamran.Deed.Authorization.Roles.Role")
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("Chamran.Deed.Authorization.Users.User")
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Chamran.Deed.Authorization.Roles.Role", b =>
                {
                    b.HasOne("Chamran.Deed.Authorization.Users.User", "CreatorUser")
                        .WithMany()
                        .HasForeignKey("CreatorUserId");

                    b.HasOne("Chamran.Deed.Authorization.Users.User", "DeleterUser")
                        .WithMany()
                        .HasForeignKey("DeleterUserId");

                    b.HasOne("Chamran.Deed.Authorization.Users.User", "LastModifierUser")
                        .WithMany()
