...
namespace Chamran.Deed.Migrations
{
    ...
    [Migration("20250722072145_AddIsPdf")]
    partial class AddIsPdf
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Chamran.Deed.Info.AllowedUserPostGroup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("AllowedUserPostGroups");
                });
            ...
            modelBuilder.Entity("Chamran.Deed.Info.DeedChart", b =>
                {
                    ...
                    b.Property<string>("LeafCationPath")
                        .HasMaxLength(400)
            ...
            modelBuilder.Entity("Chamran.Deed.Info.GetEntriesDetail", b =>
                {
                    ...
                    b.Property<bool>("ReturnedToParent")
                        .HasColumnType("bit");
                    ...
                    b.ToView("vwGetEntriesDetail", (string)null);
                });
            ...
            modelBuilder.Entity("Chamran.Deed.Info.GetEntriesDigest", b =>
                {
                    ...
                    b.Property<Guid?>("PostFile4")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid?>("PostFile5")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid?>("PostFile6")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid?>("PostFile7")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid?>("PostFile8")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid?>("PostFile9")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToView("vwGetEntriesDigest", (string)null);
                });

            modelBuilder.Entity("Chamran.Deed.Info.GetListOfUsers", b =>
                {
                    ...
                    b.ToView("vwGetListOfUsers", (string)null);
                });

            modelBuilder.Entity("Chamran.Deed.Info.GetPostsForView", b =>
                {
                    b.Property<DateTime>("CreationTime")
                        .HasColumnType("datetime2");

                    b.Property<string>("CreatorUserFirstName")
                        .HasColumnType("nvarchar(max)");

                    b.Property<long?>("CreatorUserId")
                        .HasColumnType("bigint");

                    b.Property<string>("CreatorUserLastName")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("CreatorUserName")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("CurrentPostStatus")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("GroupMemberMemberPosition")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("PostGroupPostGroupDescription")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("PostGroupPostSubGroupDescription")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("PostRefLink")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int?>("PostSubGroupId")
                        .HasColumnType("int");

                    b.Property<string>("PostTitle")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("PublisherUserFirstName")
                        .HasColumnType("nvarchar(max)");

                    b.Property<long?>("PublisherUserId")
                        .HasColumnType("bigint");

                    b.Property<string>("PublisherUserLastName")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToView("vwGetPostsForView", (string)null);
                });
            ...
            modelBuilder.Entity("Chamran.Deed.Info.InstagramCrawlerPost", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("File10Url")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("File1Url")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("File2Url")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("File3Url")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("File4Url")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("File5Url")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("File6Url")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("File7Url")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("File8Url")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("File9Url")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("InstagramCrawlerPosts");
                });
            ...
            modelBuilder.Entity("Chamran.Deed.Info.Post", b =>
                {
                    ...
                    b.Property<string>("PostFileThumb")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("PostVideoPreview")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.HasIndex("PostFile10");

                    b.HasIndex("PostFile2");

                    b.HasIndex("PostFile3");

                    b.HasIndex("PostFile4");

                    b.HasIndex("PostFile5");

                    b.HasIndex("PostFile6");

                    b.HasIndex("PostFile7");

                    b.HasIndex("PostFile8");

                    b.HasIndex("PostFile9");
            ...
            modelBuilder.Entity("Chamran.Deed.Info.PostSubGroup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("PostSubGroupDescription")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Chamran.Deed.Info.Report", b =>
                {
                    ...
                    b.ToTable("Reports", null, t =>
                        {
                            t.HasTrigger("trgAfterInsertReports");
                        });
                });
            ...
            modelBuilder.Entity("Chamran.Deed.Info.UserPostGroup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("Chamran.Deed.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("Chamran.Deed.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Chamran.Deed.Info.AllowedUserPostGroup", b =>
                {
                    b.HasOne("Chamran.Deed.Info.PostGroup", "PostGroupFk")
                        .WithMany()
            ...
            modelBuilder.Entity("Chamran.Deed.Info.Post", b =>
                {
                    ...
                    b.HasOne("Chamran.Deed.Storage.BinaryObject", "PdfBinaryObjectFk")
                        .WithMany()
                        .HasForeignKey("PdfFile");

                    b.HasOne("Chamran.Deed.Storage.BinaryObject", "AppBinaryObjectFk")
                        .WithMany()
                        .HasForeignKey("PostFile");

                    b.HasOne("Chamran.Deed.Storage.BinaryObject", "AppBinaryObjectFk10")
                        .WithMany()
                        .HasForeignKey("PostFile10");

                    b.HasOne("Chamran.Deed.Storage.BinaryObject", "AppBinaryObjectFk2")
                        .WithMany()
                        .HasForeignKey("PostFile2");

                    b.HasOne("Chamran.Deed.Storage.BinaryObject", "AppBinaryObjectFk3")
                        .WithMany()
                        .HasForeignKey("PostFile3");

                    b.HasOne("Chamran.Deed.Storage.BinaryObject", "AppBinaryObjectFk4")
                        .WithMany()
                        .HasForeignKey("PostFile4");

                    b.HasOne("Chamran.Deed.Storage.BinaryObject", "AppBinaryObjectFk5")
                        .WithMany()
                        .HasForeignKey("PostFile5");

                    b.HasOne("Chamran.Deed.Storage.BinaryObject", "AppBinaryObjectFk6")
                        .WithMany()
                        .HasForeignKey("PostFile6");

                    b.HasOne("Chamran.Deed.Storage.BinaryObject", "AppBinaryObjectFk7")
                        .WithMany()
                        .HasForeignKey("PostFile7");

                    b.HasOne("Chamran.Deed.Storage.BinaryObject", "AppBinaryObjectFk8")
                        .WithMany()
                        .HasForeignKey("PostFile8");

                    b.HasOne("Chamran.Deed.Storage.BinaryObject", "AppBinaryObjectFk9")
                        .WithMany()
                        .HasForeignKey("PostFile9");

                    b.HasOne("Chamran.Deed.Info.PostGroup", "PostGroupFk")
                        .WithMany()
                        .HasForeignKey("PostGroupId");

                    b.HasOne("Chamran.Deed.Info.PostSubGroup", "PostSubGroupFk")
                        .WithMany()
                        .HasForeignKey("PostSubGroupId");

                    b.Navigation("AppBinaryObjectFk");

                    b.Navigation("AppBinaryObjectFk10");

                    b.Navigation("AppBinaryObjectFk2");

                    b.Navigation("AppBinaryObjectFk3");

                    b.Navigation("AppBinaryObjectFk4");

                    b.Navigation("AppBinaryObjectFk5");

                    b.Navigation("AppBinaryObjectFk6");

                    b.Navigation("AppBinaryObjectFk7");

                    b.Navigation("AppBinaryObjectFk8");

                    b.Navigation("AppBinaryObjectFk9");

                    b.Navigation("GroupMemberFk");

                    b.Navigation("PdfBinaryObjectFk");
