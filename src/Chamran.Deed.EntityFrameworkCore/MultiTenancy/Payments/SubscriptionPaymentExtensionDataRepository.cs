...
{
    public class SubscriptionPaymentExtensionDataRepository : DeedRepositoryBase<SubscriptionPaymentExtensionData, long>,
        ISubscriptionPaymentExtensionDataRepository
    {
        public SubscriptionPaymentExtensionDataRepository(IDbContextProvider<DeedDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
