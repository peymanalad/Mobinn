...
namespace Chamran.Deed.Organizations
{
    public class UserOrganizationUnitRepository : DeedRepositoryBase<UserOrganizationUnit, long>,
        IUserOrganizationUnitRepository
    {
        public UserOrganizationUnitRepository(IDbContextProvider<DeedDbContext> dbContextProvider)
