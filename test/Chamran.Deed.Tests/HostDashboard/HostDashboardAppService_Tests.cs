...
using Chamran.Deed.MultiTenancy.HostDashboard;
...
namespace Chamran.Deed.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(DeedDbContext context, SubscriptionPayment subscriptionPayment)
        {
